...
<form role="form" id="insales-form" action="<?php echo (($user !== null)?'/admin/main/save/?id=' . $id :$base_url . 'cabinet/save/');?>" method="post">
    ...
    <div class="row marketing">
        ...
        <div class="col-lg-6">
            ...
            <h4>Дополнительное подтверждения заказа в модуле</h4>
    ...
    <div class="row marketing">
        ...
        <div class="col-lg-6">
            <h4>Подпись способа доставки самовывоза отдельно</h4>
            <p>
                <?php
                $attrs = array(
            ...
            <h4>Описание способа доставки самовывоза отдельно </h4>
            <p>
                <?php
                $attrs = array(
                    'placeholder' => 'Доставка товаров во все населенные пункты России + пункты самовывоза в 150 городах',
            ...
            <h4>Подпись способа доставки курьерки отдельно</h4>
            <p>
                <?php
                $attrs = array(
            ...
            <h4>Описание способа доставки курьерки отдельно </h4>
            <p>
                <?php
                $attrs = array(
                    'placeholder' => 'Доставка товаров во все населенные пункты России + пункты самовывоза в 150 городах',
    ...
    <div class="row marketing">
        ...
        <p class="bg-success">Данные габариты используются для определения цены доставки в случае, если у товара не прописаны размеры.
                              Просим внимательней отнестись к вводу данных
        </p>
        <div class="col-lg-6">
